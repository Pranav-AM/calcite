...
import org.apache.calcite.adapter.fqp.FqpPlanningMetrics;
import org.apache.calcite.adapter.fqp.RemoteCostClient;
...
public final class CachingRemoteCostClient implements RemoteCostClient {
  ...
  public CachingRemoteCostClient(RemoteCostClient delegate, FqpPlanningMetrics metrics) {
  ...
  /** Immutable cache key derived from a remote cost request. */
